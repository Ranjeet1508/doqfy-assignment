...
function AdminFeeUpdate() {
  ...
  useEffect(() => {
    axios
      .get('https://signp-login-backend.vercel.app/fee') // Assuming this is the API endpoint for fetching all fee structures
      .then((response) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios
      .put('https://signp-login-backend.vercel.app/fee', fees)
